...
function findWasmBinary() {
  return locateFile('hashcracker.wasm');
}
...
var _crackHash = Module['_crackHash'] = makeInvalidEarlyAccess('_crackHash');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['crackHash'] != 'undefined', 'missing Wasm export: crackHash');
  ...
  _crackHash = Module['_crackHash'] = createExportWrapper('crackHash', 5);
